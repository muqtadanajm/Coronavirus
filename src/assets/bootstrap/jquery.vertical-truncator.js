...
(function ($) {
	function vertical_truncator($source, ending, callback) {
		...
		if (!ending) {
			ending = '<span class="ending">... <a style="color: #ee395b;text-decoration: underline;">Read More</a></span>';
		}
		var lessing;
		if (!lessing) {
			 lessing = '<span class="ending">... <a style="color: #ee395b;text-decoration: underline;">Read Less</a></span>';
		}
		

		var $ending = $(ending);
		var $ending_link = $ending.find('a');
		var $lessing_link = $(lessing).find('a');
